...
def generate_jwt(user: User, secret_key: str, expires_in_hours: int = 1, token_type: str = "access") -> str:
    """
...
def generate_tokens(user: User, secret_key: str) -> dict:
    ...
    """
    access_token = generate_jwt(user, secret_key, expires_in_hours=1, token_type="access")
    refresh_token = generate_jwt(user, secret_key, expires_in_hours=168, token_type="refresh")
