...
savedContent.value = '<h1>Welcome to the About Page</h1><p>This is some <strong>editable</strong> content. Click the edit button to modify it.</p>';

</script>
<template>
    <div class="about-container">
        <div class="edit-button" v-if="checkAdmin()">
        ...
        <div v-else class="about-edit-container">
            <textarea v-model="editContent" class="editor" placeholder="Edit the content here..." rows="15"></textarea>
